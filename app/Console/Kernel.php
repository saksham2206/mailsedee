...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('queue:work --tries=1 --max-time=600 --stop-when-empty --timeout=12000')->everyMinute();
        ...
        $schedule->command('queue:work --tries=1 --max-time=290 --timeout=12000')->everyFiveMinutes();
