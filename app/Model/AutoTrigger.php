...
class AutoTrigger extends Model
{
    ...
    public function updateWorkflow()
    {
        ...
        // $datas = AutomationList::where('automation_id',$this->automation2->id)->where('is_executed',0)->orderByRaw("UNIX_TIMESTAMP(datetime_data) ASC")->first();
        // $origins = json_decode($datas->data,true);
        $newJson = [];
