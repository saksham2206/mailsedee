...
class User extends Authenticatable
{
    ...
    /**
     * Send welcome email post account activation.
     *
     * @return string
     */
    public function sendWelcomeMail($name = null)
    {
    ...
    public static function boot()
    {
        ...
        static::created(function ($item) {
            ...
            $sql = "insert into bounce_handeler_notification (user_id) VALUES(".$item->id.") ";
            DB::statement($sql); 
        });
    }
    ...
    public function getProfileImageUrl()
    {
        ...
        return URL::asset('users/'.$this->uid. '/' .'home/avatar/' . 'avatar.jpg');
        
        if (file_exists($path)) {
            return URL::asset('assets/images/placeholder.jpg');
        } else {
            return URL::asset('assets/images/placeholder.jpgaaa');
        }
    }
    ...
    {
        return $this->getBasePath(self::PROFILE_IMAGE_PATH."/avatar.jpg");
    }
