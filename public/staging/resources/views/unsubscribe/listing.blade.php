...
@section('page_header')
	<div class="page-title">
        <ul class="breadcrumb breadcrumb-caret position-right">
            ...
            <li class="active">Unsubscribe List</li>
        </ul>
        <h1>
            <span class="text-semibold"><i class="fa fa-hand-pointer-o"></i> Unsubscribe List</span>
        </h1>
    </div>
@endsection
@section('content')
	...
	<form class="listing-form subscribers-list"
		data-url="{{ action('SubscriberController@listUnsubscribersListing') }}"
