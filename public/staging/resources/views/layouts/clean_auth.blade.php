 ...
 <body class="loading auth-fluid-pages pb-0">
  <div class="auth-fluid">
   ...
   <div class="auth-fluid-form-box scroller_sideform">
    <div class="align-items-start d-flex h-100">
     <div class="card-body">
      <!-- Logo -->
    ...
    <div class="auth-user-testimonial">
     <h1>Reach your next lead with SENDE!</h1>
          ...
          <div class="slider_preview">
            <div class="slider_image"><img class="img img-responsive" src="/public/images/Saly-3.png" style="max-width: 100%;height: 500px;"></div>
