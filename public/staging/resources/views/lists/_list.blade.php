			...
			<tr>
				...
				<td>
					<h5 class="no-margin text-bold">
						<a class="kq_search" href="{{ action('MailListController@edit', ['uid' => $item->uid]) }}">{{ $item->name }}</a>
					</h5>
				...
				<td class="text-right">
					...
					<div class="btn-group">
						<button type="button" class="btn dropdown-toggle" data-toggle="dropdown"> Action <span class="caret ml-0"></span></button>
						<ul class="dropdown-menu dropdown-menu-right">
							<li class="user_fristicon"><a href="{{ action('SubscriberController@index', $item->uid) }}"><i class="fe-user"></i> {{ trans("messages.subscribers") }}</a></li>
