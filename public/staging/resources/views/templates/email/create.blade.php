              ...
              editor.ui.registry.addMenuButton('mybutton', {
                ...
                fetch: function (callback) {
                  var items = [
                    ...
                    {
                      type: 'menuitem',
                      text: '{SUBSCRIBER_FIRST_NAME}',
                      onAction: function () {
                        editor.insertContent('{SUBSCRIBER_FIRST_NAME}');
                      }
                    },{
                      type: 'menuitem',
                      text: '{SUBSCRIBER_EMAIL}',
                      onAction: function () {
                        editor.insertContent('{SUBSCRIBER_EMAIL}');
                      }
                    },{
                      type: 'menuitem',
                      text: '{SUBSCRIBER_COMPANY}',
                      onAction: function () {
                        editor.insertContent('{SUBSCRIBER_COMPANY}');
                      }
                    },
