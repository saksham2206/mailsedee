		...
		<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
			 <a href="{{url('/')}}" class="logo logo-light text-center">
                ...
                <span class="logo-sm left-logo">
                    <img src="{{ action('SettingController@file', \Acelle\Model\Setting::get('site_logo_small')) }}" alt="" style="width: 147px;">
                </span>
                ...
                @else
                 <span class="logo-sm">
                    <img src="{{ URL::asset('images/logo_light_blue.svg') }}" alt="" style="width: 147px;">
                </span>
                 <span class="logo-lg">
                    <img src="{{ URL::asset('images/logo_light_blue.svg') }}" alt="" style="width: 147px;" >
                </span>
