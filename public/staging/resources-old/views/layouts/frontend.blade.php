    ...
    <!-- 
            ...
            <li class="dropdown  topbar-dropdown">
                <div class="dropdown">
                  <a class=" nav-link dropdown-toggle nav-user me-0 btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img src="{{ Auth::user()->getProfileImageUrl() }}"  alt="user-image" class="rounded-circle">
        ...
        <div class="logo-box">
            ...
            <a href="{{url('/')}}" class="logo logo-light text-center">
                <span class="logo-sm">
                    <img src="https://seed.stagingwebsite.space/wp-content/uploads/2021/12/Asset-12-8.png" alt="" height="-3" style="width: 170px;">
                </span>
                <span class="logo-lg">
                    <img src="https://seed.stagingwebsite.space/wp-content/uploads/2021/12/Asset-12-8.png" alt="" style="width: 170px;">
                </span>
            </a>
        </div>
        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            <li>
                <button class="button-menu-mobile waves-effect waves-light" style="position: relative;left: 100px;">
                    <i class="fe-menu"></i>
                </button>
            </li>
