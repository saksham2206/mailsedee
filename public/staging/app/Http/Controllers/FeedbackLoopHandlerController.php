...
class FeedbackLoopHandlerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('feedback_loop_handlers.index', [
            'items' => $items,
        ]);
    }
    ...
    public function listing(Request $request)
    {
        ...
        return view('feedback_loop_handlers._list', [
            'items' => $items,
        ]);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('feedback_loop_handlers.create', [
            'server' => $server,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($server->save()) {
                ...
                return redirect()->action('FeedbackLoopHandlerController@index');
            }
        }
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('feedback_loop_handlers.edit', [
            'server' => $server,
        ]);
    }
