...
class Subscriber extends Model
{
     ...
     * @return bool
     */
    public function sendToBlacklist($reason = null,$customerId = null)
    {
        // blacklist all email
    ...
    {
        return $this->hasMany('Acelle\Model\Field','mail_list_id','mail_list_id');
    }
    ...
    public static function getValueByCustomer()
    {
        $query = self::with('getField')->whereHas('mailList',function($q){
    ...
    public static function getValueByCustomerUnsubscribe()
    {
        $query = self::where('status','unsubscribed')->with('getField')->whereHas('mailList',function($q){
            $q->where('customer_id',Auth::user()->id);
        })->get();
