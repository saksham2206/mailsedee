...
class SendingServer extends Model
{
    ...
    public static $serverMapping = array(
        ...
        self::TYPE_GMAIL => 'SendingServerGmail',
        self::TYPE_MICROSOFT => 'SendingServerMicrosoft',
    );
    ...
    {
        MailLog::info('NewTestDatas '.json_encode($server));
        ...
        MailLog::info('class_names '.$class_name);
        ...
        MailLog::info('hhhhhh '.json_encode($server->id));
        $instance->fill($server->getAttributes());

        MailLog::info('NewTestDatas '.json_encode($class_name));
        return $instance;
    }
