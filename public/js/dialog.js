            ...
            case "confirm":
                ...
                return `
                    <div class="dialog-container">
                        ...
                        <div class="dialog-footer">
                            <button class="btn btn-success btn-mc_primary dialog-ok mr-2">`+LANG_OK+`</button>
                    ...
                    return `
                        <div class="dialog-container dialog-large">
                            <div class="dialog-body p-5">
                                ...
                                `+this.message+`
                                <div>
                                    <button class="btn btn-success btn-mc_primary dialog-ok mr-2 mt-4 px-5">`+LANG_OK+`</button>
                                </div>
                            </div>
                        </div>
                    `;
                case "yesno":
                    ...
                    <div class="dialog-container">
                        ...
                        <div class="dialog-footer">
                            <button class="btn btn-success btn-mc_primary dialog-yes mr-2">`+LANG_YES+`</button>
