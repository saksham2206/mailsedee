class AutomationElement {
    static fromJson(json, container, events = {} ) {
        ...
        for (i = 0; i < json.length; i += 1) {
            ...
            if (e.type == 'ElementTrigger') {
                ...
                list[e.id].draw(700, 80, container);
    ...
    */
    ...
    drawPlus(id, cx, cy, ctype, container) {
        ...
        circle.setAttribute('style', 'fill:#ec12c0;stroke:rgb(101, 117, 138);stroke-width:1');
        ...
        if (ctype == 'plus') {
            ...
            text.setAttribute('stroke','rgb(0 0 0) !important');
            text.setAttribute('stroke-width', '2px !important');
            text.setAttribute('x', 0);
    ...
    drawAction(left, top, container, type = 'action') {
        ...
        if(navigator.userAgent.toLowerCase().indexOf('firefox') > -1){
             text.setAttribute('y', (this.DefaultRectHeight/2)+4);
        }else{
        ...
        if (type == 'action') {
            text2.setAttribute('fill', '#0000000');
        }else{
    ...
    drawNotice(id, left, top, container) {
        ...
        text.setAttribute('fill', 'pink !important');
        text.setAttribute('stroke','rgb(0 0 0) !important');
        text.setAttribute('stroke-width', '2px !important');
        text.innerHTML = '&#xf12a;';
