...
@section('content')
    ...
    <form class="" role="form" method="POST" action="{{ url('/password/reset') }}">
        ...
        <span class="help-block">
            ...
            <div class="form-group mb-3 has-feedback has-feedback-left{{ $errors->has('password') ? ' has-error' : '' }}">
        ...
        <span class="help-block">
            ...
            <div class="form-group mb-3 has-feedback has-feedback-left{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
        ...
        <span class="help-block">
            ...
            <a href="{{ url("/login") }}" class="btn btn-white btn-lg btn-block text-semibold mt-3">
