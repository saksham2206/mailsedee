...
<head>
	...
	@php            
        ...
        @php 
        $small = \Acelle\Model\Setting::get('site_logo_small'); 
        $large = \Acelle\Model\Setting::get('site_logo_large');
        @endphp
    ...
    <!-- 
        ...
        <div class="logo-box">
            ...
            <a href="{{url('/')}}" class="logo logo-light text-center">
                <span class="logo-sm">
                    <!-- <img src="{{ URL::asset('assets/images/logo-black.png') }}" alt="" height="22"> -->
                    <img src="{{ URL::asset('public/setting/'.$large) }}" alt="" height="22">
                </span>
                <span class="logo-lg">
                    <!-- <img src="{{ URL::asset('assets/images/logo-black.png') }}" alt="" > -->
                    <img src="{{ URL::asset('public/setting/'.$small) }}" alt="" >
                </span>
            </a>
        </div>
