        ...
        <div class="col-md-10">
        	<div class="page-title">
	            <ul class="breadcrumb breadcrumb-caret position-right">
                    ...
                    <li>Sending</li>
                    <li><a href="javascript:void(0);">{{ trans('messages.bounce_handlers') }}</a></li>
	            </ul>
	            <h1>
	                <span class="text-semibold"><i class="fe-send"></i> {{ trans('messages.bounce_handlers') }}</span>
	            </h1>
...
@section('content')
    ...
    <form class="listing-form"
        sort-url="{{ action('BounceHandlerController@sort') }}"
        data-url="{{ action('BounceHandlerController@listing') }}"
        ...
        <div class="row top-list-controls">
            <div class="col-md-9">
                    ...
                    <div class="filter-box">
                        <div class="btn-group list_actions hide">
                            ...
                            <ul class="dropdown-menu">
                                <li><a delete-confirm="{{ trans('messages.delete_bounce_handlers_confirm') }}" href="{{ action('BounceHandlerController@delete') }}"><i class="icon-trash"></i> {{ trans('messages.delete') }}</a></li>
                            </ul>
                        </div>
                ...
                <div class="col-md-3 text-right">
                    <a href="{{ action('BounceHandlerController@create') }}" type="button" class="btn bg-info-800">
