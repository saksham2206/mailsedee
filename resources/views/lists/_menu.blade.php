    ...
    <div class="col-md-12">
        <ul class="nav nav-tabs nav-tabs-top page-second-nav">
            ...
            <li rel0="FieldController/index">
                ...
                <i class="fe-list"></i> {{ trans('messages.manage_list_fields') }}
                </a>
            </li>
