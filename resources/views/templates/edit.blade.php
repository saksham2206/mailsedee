...
@section('content')
    ...
    <form id="classic-builder-form" style="margin-top: 56px;" action="{{ action('TemplateController@update', $template->uid) }}" method="POST" class="ajax_upload_form form-validate-jquery builder-classic-form listing-form">
        {{ csrf_field() }}
