...
@section('page_header')
    ...
    <div class="page-title">                
        <ul class="breadcrumb breadcrumb-caret position-right">
            ...
            <li><a href="javascript:void(0);">{{ trans('messages.templates') }}</a></li>
        </ul>
        <h1>
            <span class="text-semibold"><i class="fe-check-square"></i> {{ trans('messages.templates') }}</span>
        </h1>                
    </div>
...
@section('content')
    ...
    >                
        <div class="row top-list-controls">
            ...
            <div class="col-md-2 text-right align-items-center pr-0">
