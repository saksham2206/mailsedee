    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <form action="{{ url("automation/store") }}" method="POST" class="form-validate-jqueryz">
                ...
                <fieldset> -->
                <div class="mainDiv">
                    <div class="col-sm-6" id="segment_1">
                        <input type="hidden" name="segmentNumber" id="segmentNumber" value="1">
                        <a href="javascript:void(0);" onclick="showEmailTemplatePopup(1);"  id="create_sequence_btn">Create Sequence</a>
                        <div class="data" id="data_1" style="height: 900px;"></div>
                        <input type="hidden" name="sequence-steps" id="sequence-steps_1" value="0">
                        

                    </div>
                    
                    <a href="javascript:void(0);" onclick="AddSegment();">A/B Testing</a>
                    </div>
                    <div class="hide segment" id="segment">
                        ...
                        <div class="data" style="height: 900px;"></div>
            ...
            $.ajax({
                ...
                success:function(response){
                    ...
                    if(obj.status == true){
                        ...
                        var html = "<div class='col-md-6 outer-box  col-sm-12' >";
                        html += "<div class='row'>";
                             html += '<div class="form-group"><div class="fav-mail"><i class="fa fa-envelope text-info"></i><span>'+obj.data.subject+'</span><button type="button" class="btn btn-edit">Edit</button><div class="comment"><p>'+obj.data.content+'</p></div></div><div class="footer-sec"><h3>1 REMAINING</h3></div></div><div class="border-clock"><i class="fa fa-clock"></i><h3>5 Days</h3></div><div class="border-section"></div>';
